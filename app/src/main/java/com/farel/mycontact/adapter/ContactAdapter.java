package com.farel.mycontact.adapter;
...
import com.farel.mycontact.InputActivity;
import com.farel.mycontact.R;
import com.farel.mycontact.TampilActivity;
...
public class ContactAdapter extends
    ...
    public ContactViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int
        ...
        View view = layoutInflater.inflate(R.layout.list_contact, parent,
                false);
        return new ContactViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int
            position) {
