...
import com.farel.mycontact.model.ResponseData;
import com.farel.mycontact.services.ApiClient;
import com.farel.mycontact.services.ApiContact;
...
public class InputActivity extends AppCompatActivity {
        ...
        if (data.getString("OPERATION").equals("insert")) {
            ...
            if (!imgLocation.equals(null)) {
                Picasso.Builder builder = new
                        Picasso.Builder(getApplicationContext());
                builder.downloader(new
                        OkHttp3Downloader(getApplicationContext()));
    ...
    private void saveData() {
        ...
        if (!(firstName.equals("") && lastName.equals("") && number.equals(""))) {
            ApiContact api =
                    ApiClient.getRetrofitInstance().create(ApiContact.class);
            Call<ResponseData> call;
            if (updateOperation == false) {
                call = api.addData(firstName, lastName, number, email,
                        imgLocation, gender);
            } else {
                call = api.editData(String.valueOf(id), firstName, lastName,
                        number, email, imgLocation, gender);
                updateOperation = false;
            }
            call.enqueue(new Callback<ResponseData>() {
                ...
                public void onResponse(Call<ResponseData> call,
                    ...
                    if (value.equals("1")) {
                        Toast.makeText(InputActivity.this, "SUKSES: " + message,
                                Toast.LENGTH_LONG).show();
                        finish();
                    } else {
                        Toast.makeText(InputActivity.this, "GAGAL: " + message,
                                Toast.LENGTH_LONG).show();
                    }
                }
            ...
            Toast.makeText(this, "Data nama dan nomor telepon harus diberikan",
                    Toast.LENGTH_LONG).show();
        }
    }
                        ...
                        DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ApiContact api =
                                        ApiClient.getRetrofitInstance().create(ApiContact.class);
                                Call<ResponseData> call =
                                        api.deleteData(String.valueOf(id));
                                call.enqueue(new Callback<ResponseData>() {
                                    @Override
                                    public void onResponse(Call<ResponseData> call,
                                                           Response<ResponseData> response) {
                                        ...
                                        if (value.equals("1")) {
                                            ...
                                            Toast.makeText(InputActivity.this, "GAGAL: "
