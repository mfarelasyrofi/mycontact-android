...
import com.farel.mycontact.adapter.ContactAdapter;
import com.farel.mycontact.model.Contact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent openInput = new Intent(getApplicationContext(),
                        InputActivity.class);
        ...
        call.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call,
                ...
                if (value.equals("1")) {
                    ...
                    contactAdapter = new ContactAdapter(dataContact,
